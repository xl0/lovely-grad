...
[![](https://alexey.work/badge/)](https://alexey.work/?ref=lg-md)
...
```
    ...
    <Tensor <UOp CPU (2, 6) float (<Ops.ASSIGN: 69>, None)> on CPU with grad None>
    Tensor[2, 6] n=12 x∈[-3.540e+03, 1.000] μ=-392.827 σ=1.113e+03 +Inf! -Inf! NaN! CPU Realized ASSIGN
...
```
    ...
    Tensor[3, 196, 196] n=115248 x∈[1.815e-09, 1.000] μ=0.361 σ=0.248 CPU Realized ADD
...
```
    ...
    Tensor[3] x∈[1.0e+00, 2.0e+00] μ=nan σ=nan CPU Realized COPY [1.0e+00, 2.0e+00, nan]
...
```
    ...
    Tensor[2] μ=1.500 σ=0.707 CPU Realized COPY [1.000, 2.000]
